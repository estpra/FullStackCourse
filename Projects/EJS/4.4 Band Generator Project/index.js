...
app.get("/", (req, res) => {
  ...
  // console.log(`adj size: ${adj.length}`)
  // console.log(`noun size: ${noun.length}`)
});
...
app.post("/submit", (req, res) => {
  ...
  // const currentAdj = adj[Math.floor(Math.random() * )]
  let adjIndex = Math.floor(Math.random() * adj.length)
  let nounIndex = Math.floor(Math.random() * noun.length)
  res.render("index.ejs", {
    currentAdj: adj[adjIndex],
    currentNoun: noun[nounIndex]
  })
});
